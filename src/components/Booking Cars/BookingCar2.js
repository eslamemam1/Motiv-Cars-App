...
import loveIcon from "../../Pictures/redLove.svg";
import mercedesBenz from "../../Pictures/mercedes-benz.png";
import VectorUser from "../../Pictures/VectorUser.svg";
import VectorUser2 from "../../Pictures/VectorUser2.svg";

function BookingCar2() {
  return (
    <div className=" relative w-[325px] h-[267px] rounded-[16px] bg-[#FFFFFF]">
      <div className=" w-[277px] m-auto">
        ...
        <img
          className="w-[191px] h-[111px] absolute top-[94px] left-[46px] "
          src={mercedesBenz}
          alt="mercedesBenz"
        />
